    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 animate-pulse">
      {[...Array(4)].map((_, i) => (
        <div key={i} className="h-14 sm:h-16 bg-card border border-border-card rounded-[26px] p-3.5 sm:p-4 flex items-center justify-between">
          <div className="w-16 h-3.5 bg-canvas rounded-[10px]" />
          <div className="w-12 h-5 bg-canvas rounded-[12px]" />
        </div>
      ))}
    </div>
  );
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="space-y-1.5">
              <div className="w-24 h-3.5 rounded-[10px] bg-canvas" />
              <div className="w-16 h-2.5 rounded-[8px] bg-canvas" />
            </div>
          </div>
          <div className="w-20 h-3.5 rounded-[10px] bg-canvas hidden sm:block" />
