...
export function MobileSystemDetail({
  ...
  return (
    <div className="w-full space-y-4">
      {/* TOP BAR (§3 Section D: Frosted Glass Sticky Mobile Drill-down Header) */}
        ...
        <div className="h-16 flex items-center justify-between relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center px-24 pointer-events-none">
            {isEditMode ? (
              ...
              <h2 className="text-base font-semibold text-text-main truncate text-center max-w-full pointer-events-auto">
                {activeSection.title}
              </h2>
            )}
          </div>
